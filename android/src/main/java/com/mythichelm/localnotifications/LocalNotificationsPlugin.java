...
public class LocalNotificationsPlugin implements MethodCallHandler, NewIntentListener {
    ...
    public static boolean handleIntent(Intent intent) {
        ...
        System.out.println("Inteeeeeeeeeeeeeeeeeent");
        if (intent == null) {
